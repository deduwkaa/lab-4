...
function createEmployeeObject() {
  ...
  employeeObject.surname = "Прізвище";
  employeeObject.name = "Ім'я";
...
function copyPropertiesAndMethods() {
  ...
  employeeObject.surname = "Прізвише";
  employeeObject.name = "Ім'я";
  employeeObject.gender = "Чоловіча";
  employeeObject.age = 25;
...
function addShowDataMethod() {
  ...
  exampleEmployee.surname = "Прикладовий";
  exampleEmployee.name = "Співробітник";
...
function createManagerObject() {
  ...
  managerObject.surname = "Новий";
  managerObject.name = "Керівник";
...
function showEmployeeAndManagerClass() {
  let employeeClass = new EmployeeClass("Прикладовий", "Співробітник", "Чоловіча", 30);
  employeeClass.setAge = 31;
  console.log(`Повне ім'я: ${employeeClass.fullName}`);
  employeeClass.showData();

  let managerClass = new ManagerClass("Новий", "Керівник", "Жіноча", 35, "department розробки");
  ...
  resultField.innerHTML = `
    <p>
      ...
      <br/>
      managerClass: Прізвище: ${this.surname}, Ім'я: ${this.name}, Стать: ${this.gender}, Вік: ${this.age}, Відділ: ${this.department}    
    </p>
  `
}
